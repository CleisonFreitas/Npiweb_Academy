...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/cleison/.vscode/extensions/wallabyjs.console-ninja-1.0.461/out/buildHook/index.js').default({tool: 'webpack', checkSum: '205e0e2e7713da65400a1cAEsDUxxXDQVTVlFTVVNRBgUDBFYG', mode: 'build'}); } catch(cjsError) { try { import('file:///home/cleison/.vscode/extensions/wallabyjs.console-ninja-1.0.461/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '205e0e2e7713da65400a1cAEsDUxxXDQVTVlFTVVNRBgUDBFYG', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
